...
#dmd -ofd_shogi -m64 -inline -release -unittest -J. -O releaseBinary.d
ldc2 -ofd_shogi -m64 -inline -release -unittest -J. -mcpu=x86-64 -mattr=+sse4.2 -O -O5  releaseBinary.d
